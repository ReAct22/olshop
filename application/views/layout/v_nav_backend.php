          ...
          <!-- Add icons to the links using the .nav-icon class
              ...
              <p>
                Dashboard
					...
					<li class="nav-item">
           			 <a href="<?php echo base_url('kategori') ?>" class="nav-link <?php if($this->uri->segment(1) == 'kategori'){
							echo "active";
							} ?>">
              ...
              <p>
                Kategori
					...
					<li class="nav-item">
           			 <a href="<?php echo base_url('barang') ?>" class="nav-link <?php if($this->uri->segment(1) == 'barang'){
							echo "active";
							} ?>">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p>User </p>
					...
					<li class="nav-item">
            <a href="<?php echo base_url('auth/logout_user') ?>" class="nav-link">
